...
FastV wins its reference-grounded home regime (TextVQA/GQA/DocVQA cells),
...
query-conditioned strong baseline FastV leads it on TextVQA/GQA/DocVQA
(Table~\ref{tab:tab3}), and on Qwen GQA the apparent
