...
%  Converted from drafts/supp_acmmm.md (S1--S10). Double-blind.
%
...
submission. Nothing in this supplement identifies authors, institutions, or
repositories (double-blind).
