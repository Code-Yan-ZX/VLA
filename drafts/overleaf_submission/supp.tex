...
not used to test partial-credit metric differences. The full-split GQA post
lead is an order of magnitude smaller than the text-dense gaps and is reframed
by the pre-final control (S7b) as a layer-8 ranking artifact rather than a true
stage reversal. $^{a}$~Qwen3-VL none-DocVQA native-resolution
