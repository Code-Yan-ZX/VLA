...
\setcopyright{none}
% Official ACM MM 2027 dates/DOI are not yet published. Suppress acmart's
% Conference'17 / 10.1145 placeholder block in the anonymous review PDF.
\settopmatter{printacmref=false, printccs=true, printfolios=true}
\acmConference[Anonymous Review]{Anonymous Review}{2027}{}
\acmYear{2027}
...
robust OCR-oriented default. Six prespecified extensions do not improve over
...
map its trade-off against FastV, and show that six prespecified extensions do
...
all three Qwen3-VL non-OCR cells ($+17.2 / +8.9 / +16.2$~pp) and on
Qwen2.5-VL TextVQA ($+7.8$~pp). This is the query-dependent
