...
protocol differ), only the direction$\times$workload pattern is. Supplementary
Section~S11 reports the full-precision cell scores, prompt-token audit, answer
convergence counts, and the 4096-token diagnostic.
